//
//  MyClassScheduleViewController.m
//  CSUN
//
...
@implementation MyClassScheduleViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];	
	self.navigationItem.title = @"My Class Schedule";
	
	appDelegate = (CSUNAppDelegate *)[[UIApplication sharedApplication] delegate];
	data = [[NSMutableArray alloc]init];
	data = appDelegate.myClassesArray;
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
	...
	CGRect classNumberRect = CGRectMake(5, 5, 105, 20);
	...
	CGRect locTextRect = CGRectMake(110, 5, 90, 20);
	...
	CGRect daysTextRect = CGRectMake(205, 5, 60, 20);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	myClass *cur = [[myClass alloc] init];	
	cur = [data objectAtIndex:indexPath.row];
	
	NSString *className = [NSString stringWithFormat:@"%@/%@", cur.Subject, cur.CatlgNbr];
	
	classNumberLabel.text = [NSString stringWithFormat:@"%@", className];

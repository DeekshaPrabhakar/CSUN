...
- (void)viewDidLoad {
	...
	AboutCSUN *abtObj = appDelegate.aboutObj;
	//[self.view setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
	controllers = abtObj.historyArray;
}
...
-(NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
	History *hObj = [[History alloc]init];
	hObj = [self.controllers objectAtIndex:section];
	return hObj.title;
}
...
{
	History *hObj = [[History alloc]init];
	hObj = [self.controllers objectAtIndex:indexPath.section];
	
	NSString *cellText = hObj.text;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	History *hObj = [controllers objectAtIndex:row];
	cell.textLabel.text = hObj.text;
